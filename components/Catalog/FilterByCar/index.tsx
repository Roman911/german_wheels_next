...
const FilterByCar: FC<Props> = ({ locale, openFilter, handleClick }) => {
	...
	return (
		<div className='flex justify-between lg:justify-end items-center lg:items-start mb-3'>
			...
			<FilterBtn openFilter={ openFilter } title={ t('filters') }/>
			<div className="relative inline-block text-left">
				...
				<div
					className={ twMerge(
						'absolute right-0 z-10 w-56 xl:w-64 origin-top-right border border-gray-200 bg-white shadow-lg p-3 xl:p-5 rounded-sm',
						!openSort && 'hidden')
					}
					tabIndex={ -1 }>
